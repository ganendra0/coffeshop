    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row d-flex">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_2.jpg') }}');">
                        </a>
                        <div class="text py-4 d-block">
                            <div class="meta">
                                <div><a href="#">Sept 10, 2018</a></div>
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a href="{{ url('/blog-single') }}" class="block-20" style="background-image: url('{{ asset('images/image_3.jpg') }}');">
                        </a>
                        <div class="text py-4 d-block">
                            <div class="meta">
                                <div><a href="#">Sept 10, 2018</a></div>
